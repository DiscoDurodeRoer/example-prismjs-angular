...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // codigo a resaltar, cuando con los espacios
    const code = `
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * -->
    <!-- * * * * * * * * * * * The content below * * * * * * * * * * * -->
    ...
    // Convierte el codigo a html con todas las etiquetas
    // https://prismjs.com/docs/Prism.html#.highlight
    this.html = Prism.highlight(code, Prism.languages.html, 'html')
